...
<Callout type="info">
  **Attribution:** This package is built on top of and derived from
  ...
  Full credit for the original fundamental engine and architecture goes to [@xzdarcy](https://github.com/xzdarcy).
  This fork by [@keplar-404](https://github.com/keplar-404) introduces major custom capabilities.
</Callout>
